...
public class MainActivity extends AppCompatActivity {
    ...
    Movie mItem;
    Integer[] poster = {R.drawable.mov01,R.drawable.mov02,R.drawable.mov03,R.drawable.mov04,R.drawable.mov05,R.drawable.mov06,
            R.drawable.mov07,R.drawable.mov08,R.drawable.mov09,R.drawable.mov10 };
    String[] title={"토이4","호빗","제이스본","반지의 제왕","정직한 후보","나쁜녀석들",
            "겨울왕국","알라딘","극한직업","스파이더맨"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0; i<poster.length; i++){
            mItem = new Movie(ContextCompat.getDrawable(this, poster[i]),
                    title[i], genre[i]);
            mArray.add(mItem);
